...
export const { setProductUrl, setAsinNumber, setProductTitle, setProductDescription, setRegularPrice, setSalePrice, setPrimaryImageUrl, setProductCategories, setProductAddSuccessful, resetState } = productAddSlice.actions
